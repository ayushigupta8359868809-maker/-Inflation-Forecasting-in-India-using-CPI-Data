...
# Objectives
* Analyze inflation behavior using CPI data
* Study monthly and yearly CPI trends
...
* ARIMA & SARIMA Models
# key Results
* CPI shows noticeable monthly fluctuations with a clear long-term trend
* ARIMA and SARIMA models provide reliable short-term inflation forecasts
* CPI is effective for inflation analysis and forecasting
